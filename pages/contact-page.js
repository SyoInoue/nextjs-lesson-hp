    ...
    <Layout title="Contact">
      <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
        ...
        <div className="mt-6 flex justify-around">
          <div>
            <a
              href="https://twitter.com/syo_0329_"
              target="_blank" //別タブで開く
              rel="noopener noreferrer" //参照先に情報を渡さない。
            >
              <svg //少ないデータ量で豊かな表現ができる画像フォーマット
                className="w-6 h-6 mr-3 text-blue-500"
                stroke="currentColor" //現在のテキストの色に設定。strokeは枠線
                fill="#1c1c16" //現在のテキストの色に設定。fillは塗り
                viewBox="0 0 512 512" //大きさ
                xmlns="http://www.w3.org/2000/svg" //名前空間
              >
